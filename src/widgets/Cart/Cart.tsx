  ...
  return(
    <>
      ...
      <div className="cart__header-block">
        ...
        <button className='all_clear_button' onClick={removeCart}>Очистить корзину</button>
      </div>
        ...
        <article className="product">
          ...
          <div className="product-information">
            <div className="product-header-block">
              <div className="product-typeBlock">
                <p className="product-typeBlock__text">{item.typeBoard}</p>
              </div>
              <button className="trash-button">
                <svg className="trash" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="product-name__text">{item.name} пиломатериал</p>
            <div className="product-description">
            <span>{item.width} x {item.thickness}</span>
            </div>
          
          <div className="product-block">
            <div className="quantity-block">
              <button className="quantity-button" onClick={()=>{decQuantity(item)}}>-</button>
              <span className="quantity-text">{item.quantity}</span>
              <button className="quantity-button" onClick={()=>{incQuantity(item)}}>+</button>
            </div>

            <div className="price-block">
              <p className="price-block__text">{item.price}</p>
            </div>
